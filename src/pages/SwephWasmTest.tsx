...
import { SwephWasmService } from '../lib/sweph-wasm-service';

const SwephWasmTest: React.FC = () => {
  ...
  const runTest = async () => {
    ...
    try {
      console.log('🚀 Début du test SwephWasm...');
      await SwephWasmService.testNeuilly();
    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">
          Test Swiss Ephemeris (sweph-wasm)
        </h1>
        ...
        <div className="mt-8 text-sm text-gray-400">
          ...
          <p>🔍 Le test calcule l'Ascendant et le MC avec le système Placidus</p>
        </div>
      </div>
    </div>
  );
